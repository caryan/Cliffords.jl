...
# XOR of the bits
*(a::Pauli{1}, b::Pauli{1}) = Pauli(xor(a.v[1], b.v[1]),
                                    mod(a.s + b.s + levicivita(a.v[1], b.v[1]),4))
*(a::Pauli{2}, b::Pauli{2}) = Pauli{2}(SVector{2,UInt8}(xor(a.v[1],  b.v[1]), xor(a.v[2], b.v[2])),
                                       mod(a.s + b.s + levicivita(a.v, b.v),4))
*{N}(a::Pauli{N}, b::Pauli{N}) = Pauli{N}(SVector{N,UInt8}(ntuple(i -> xor(a.v[i], b.v[i]), N)),
                                          mod(a.s + b.s + levicivita(a.v, b.v),4))
